...
class EnvironmentService {
  ...
  getSportsIOKey(): string | undefined {
  ...
  getConfigurationStatus() {
    ...
    return {
      ...
      sportsData: {
        configured: !!this.config.SPORTS_IO_API_KEY,
  ...
  getDebugInfo() {
    ...
    return {
      ...
      supabaseConfigured: !!(this.config.NEXT_PUBLIC_SUPABASE_URL && this.config.NEXT_PUBLIC_SUPABASE_ANON_KEY),
