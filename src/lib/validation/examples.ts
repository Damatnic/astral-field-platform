...
import { z } from 'zod';
import { createValidationMiddleware, validateRequestBody,
...
const postValidationMiddleware  = createValidationMiddleware({ bodySchema: postCreateSchema,
...
const adminActionMiddleware  = createValidationMiddleware({ bodySchema: adminActionSchema,
  sanitize: true,
