...
export async function validateChatMessage(
  ...
  return validateRequestBody(request, schemas.chatMessageSchema, {
    sanitize: true,
...
export async function validateAdminAction(
  ...
  return validateRequestBody(request, schemas.adminActionSchema, {
    sanitize: true,
 ...
 */
export function validateSecurityPatterns(data: any): ValidationResult<any> {
 ...
 */
export function hasValidationErrors(result: ValidationResult<any>): result is ValidationResult<any> & { success: false; errors: ValidationError[] } {
...
): ValidationResult<{ key: string; limit: number; window: number }> {
  try {
