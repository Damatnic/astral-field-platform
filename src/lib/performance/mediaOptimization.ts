...
export const OPTIMIZATION_PRESETS = {
  mobile: {
    thumbnail: { quality: 60, width: 150, height: 150, format: 'webp' as const },
    small: { quality: 70, width: 400, height: 300, format: 'webp' as const },
    medium: { quality: 75, width: 800, height: 600, format: 'webp' as const },
    large: { quality: 80, width: 1200, height: 900, format: 'webp' as const },
    hero: { quality: 85, width: 1600, height: 1200, format: 'webp' as const }
  },
  desktop: {
    thumbnail: { quality: 70, width: 200, height: 200, format: 'webp' as const },
    small: { quality: 75, width: 600, height: 400, format: 'webp' as const },
    medium: { quality: 80, width: 1000, height: 750, format: 'webp' as const },
    large: { quality: 85, width: 1600, height: 1200, format: 'webp' as const },
    hero: { quality: 90, width: 2400, height: 1800, format: 'webp' as const }
  }
};
...
export function getOptimalImageConfig(
  ...
  if (connection.saveData) {
    ...
    qualityMultiplier = 0.6; // Reduce quality by 40% for slow connections
  } else if (connection.effectiveType === '3g') {
    qualityMultiplier = 0.8; // Reduce quality by 20% for 3G
  }
...
export function generateResponsiveSrcSet(
  ...
  return sizes.map(({ width, quality = 75 }) => {
...
export function getImageLoadMetrics(): ImageLoadMetrics[] {
  return [...imageMetrics];
}
