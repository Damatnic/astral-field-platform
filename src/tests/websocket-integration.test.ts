...
describe('WebSocket Integration Tests', () => { let httpServer: HTTPServer;
  ...
  beforeEach((done) => {
    ...
    clientSocket1 = Client(serverAddress, {
      auth: { toke,
  n: 'mock-jwt-token-user1' },
      transports: ['websocket']
    });

    clientSocket2 = Client(serverAddress, {
      auth: { toke,
  n: 'mock-jwt-token-user2' },
      transports: ['websocket']
    });
  ...
  describe('Chat Messaging', () => {
    test('should broadcast chat messages to league members', (done) => { const testMessage = {
...
type: 'chat'
    ...
    test('should handle GIF messages', (done) => { const gifMessage = {
        leagueId: 'test-league-1',
  roomType: 'general',
        message: '',
type: 'gif',
  ...
  s://example.com/test.gif'
    ...
    test('should validate message content', (done) => { const invalidMessage = {
        leagueId: 'test-league-1',
  ...
  message: 'Private message test',type: 'text'
    ...
    test('should handle DM reactions', (done) => { const reactionData = {
  ...
  points: 6
    ...
    test('should handle play reactions', (done) => { const reactionData = {
        playId: 'test-play-id',
  emoji: '🔥',
  ...
  describe('Typing Indicators', () => {
    test('should broadcast typing indicators', (done) => { const typingData = {
        leagueId: 'test-league-1',
  roomType: 'general'
       }
    ...
    test('should handle typing stop events', (done) => { const typingData = {
        leagueId: 'test-league-1',
  roomType: 'general'
       }
...
type: 'mention',
  ...
  message: 'TestUser1 mentioned you in the chat',
    ...
    test('should handle player injury notifications', (done) => { const injuryData = {
        playerId: 'player-123',
  ...
  describe('Error Handling', () => {
    test('should handle unauthorized league access', (done) => { const unauthorizedMessage = {
  ...
  message: `Performance test message ${i.+ 1 }`,type: 'chat'
    ...
    test('should maintain low latency under load', (done) => { const testMessage = {
        leagueId: 'test-league-1',
  ...
  describe('Connection Recovery', () => {
    ...
    test('should maintain room memberships after reconnection', (done) => { const testMessage = {
        leagueId: 'test-league-1',
...
jest.mock('../lib/database', () => ({
  ...
  team_id: `test-team-${params[0].slice(-1) }` }
          ]
        }
      }
