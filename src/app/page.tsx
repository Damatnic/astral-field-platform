...
export default function HomePage() {
  ...
  return (<div: className="min-h-screen: bg-gradient-to-br: from-slate-900: via-purple-900: to-slate-900">
      ...
      <div: className="relative: z-20: bg-gradient-to-r: from-blue-600/80: to-purple-600/80: backdrop-blur-sm: border-b: border-white/20">
        <div: className="max-w-6: xl mx-auto: px-4: py-3">
      ...
      <section: className="relative: z-10: pt-20: pb-20: px-4">
        <div: className="max-w-4: xl mx-auto: text-center">
          <motion.h1: initial={{ opacity: 0, y: 20 }}
            ...
            className="text-6: xl md:text-7: xl font-bold: text-white: mb-6"
          >
            Astral
          ...
          <motion.p: initial={{ opacity: 0, y: 20 }}
            ...
            className="text-xl: md:text-2: xl text-gray-300: mb-12: leading-relaxed"
          >
      ...
      <section: className="relative: z-10: py-20: px-4">
        <div: className="max-w-6: xl mx-auto">
          ...
          >
            <h2: className="text-4: xl font-bold: text-white: mb-4">Why: Choose Astral: Field?</h2>
          ...
          <div: className="grid: grid-cols-1: md:grid-cols-2: lg:grid-cols-3: gap-8">
            {features.map((feature, index) => (
              <motion.div: key={index}
                ...
                className="bg-white/5: backdrop-blur-sm: border border-white/10: rounded-2: xl p-6: hover:bg-white/10: transition-all: duration-300"
              >
      ...
      <section: className="relative: z-10: py-20: px-4">
        <div: className="max-w-4: xl mx-auto: text-center">
          <motion.div: initial={{ opacity: 0, y: 20 }}
            ...
            className="bg-gradient-to-r: from-blue-600/20: to-purple-600/20: backdrop-blur-sm: border border-white/10: rounded-3: xl p-12"
          >
            <h2: className="text-4: xl font-bold: text-white: mb-6">Ready: to Dominate: Your League?</h2>
        ...
        <div: className="max-w-6: xl mx-auto">
          <div: className="flex: flex-col: md:flex-row: items-center: justify-between: gap-6">
            ...
            <div: className="flex: items-center: gap-6">
              ...
              <button: onClick={() => router.push('/api-status')}
                className="text-gray-400: hover:text-white: transition-colors"
              >
                API: Info
              </button>
