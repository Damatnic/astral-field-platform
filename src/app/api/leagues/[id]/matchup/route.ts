...
const mockPlayers = [
  // QB
  { id: '1', name: 'Josh Allen', position: 'QB', team: 'BUF', points: 24.5, projected: 22.8, status: 'active' },
  { id: '2', name: 'Patrick Mahomes', position: 'QB', team: 'KC', points: 21.3, projected: 24.1, status: 'active' },
  
  // RB  
  { id: '3', name: 'Christian McCaffrey', position: 'RB', team: 'SF', points: 18.7, projected: 19.5, status: 'active' },
  { id: '4', name: 'Derrick Henry', position: 'RB', team: 'BAL', points: 16.2, projected: 15.8, status: 'active' },
  { id: '5', name: 'Alvin Kamara', position: 'RB', team: 'NO', points: 13.4, projected: 14.2, status: 'active' },
  
  // WR
  { id: '6', name: 'Tyreek Hill', position: 'WR', team: 'MIA', points: 15.8, projected: 16.5, status: 'active' },
  { id: '7', name: 'Davante Adams', position: 'WR', team: 'LV', points: 14.2, projected: 15.1, status: 'active' },
  { id: '8', name: 'Stefon Diggs', position: 'WR', team: 'HOU', points: 12.6, projected: 13.8, status: 'active' },
  { id: '9', name: 'DeAndre Hopkins', position: 'WR', team: 'TEN', points: 11.3, projected: 12.4, status: 'active' },
  
  // TE
  { id: '10', name: 'Travis Kelce', position: 'TE', team: 'KC', points: 12.8, projected: 14.2, status: 'active' },
  { id: '11', name: 'Mark Andrews', position: 'TE', team: 'BAL', points: 9.4, projected: 11.6, status: 'active' },
  
  // K
  { id: '12', name: 'Justin Tucker', position: 'K', team: 'BAL', points: 8.0, projected: 7.5, status: 'active' },
  { id: '13', name: 'Harrison Butker', position: 'K', team: 'KC', points: 6.5, projected: 8.2, status: 'active' },
  
  // DST
  { id: '14', name: 'Bills DST', position: 'DST', team: 'BUF', points: 12.0, projected: 9.5, status: 'active' },
  { id: '15', name: '49ers DST', position: 'DST', team: 'SF', points: 8.5, projected: 10.2, status: 'active' }
];
