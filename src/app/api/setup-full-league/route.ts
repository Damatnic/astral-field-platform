  ...
  try {
    ...
    const result = await database.transaction(async (client) => {
      ...
      const originalPlayers = [
        { id: '1', email: 'nicholas@example.com', username: 'Nicholas D\'Amato', pin: '1234' },
        { id: '2', email: 'kaity@example.com', username: 'Kaity Lorbecki', pin: '5678' },
        { id: '3', email: 'mike@example.com', username: 'Mike Johnson', pin: '9999' },
        { id: '4', email: 'sarah@example.com', username: 'Sarah Wilson', pin: '1111' },
        { id: '5', email: 'david@example.com', username: 'David Chen', pin: '2222' },
        { id: '6', email: 'emily@example.com', username: 'Emily Rodriguez', pin: '3333' },
        { id: '7', email: 'alex@example.com', username: 'Alex Thompson', pin: '4444' },
        { id: '8', email: 'jessica@example.com', username: 'Jessica Lee', pin: '5555' },
        { id: '9', email: 'ryan@example.com', username: 'Ryan Davis', pin: '6666' },
        { id: '10', email: 'amanda@example.com', username: 'Amanda Taylor', pin: '7777' }
      ];

      // Create users with proper UUIDs
      for (let i = 0; i < originalPlayers.length; i++) {
        const player = originalPlayers[i];
        await client.query(`
      ...
      const teamIds = [];
      for (let i = 0; i < 10; i++) {
        const teamId = `00000000-0000-0000-0000-00000000001${i}`;
      ...
      for (const draftPick of draftOrder) {
        ...
        await client.query(`
          INSERT INTO draft_picks (league_id, team_id, player_id, round, pick, overall_pick)
          VALUES ($1, $2, $3, $4, $5, $6)
        `, [
          '00000000-0000-0000-0000-000000000001',
          teamId,
        ...
        if (selectedPlayer.position === 'RB' && teamNeeds.RB >= 2) {
          rosterPosition = 'FLEX';
        } else if (selectedPlayer.position === 'WR' && teamNeeds.WR >= 3) {
          rosterPosition = 'FLEX';
        } else if (selectedPlayer.position === 'TE' && teamNeeds.TE >= 1) {
          rosterPosition = 'FLEX';
        }
        
        if (draftPick.round > 9) {
          rosterPosition = 'BENCH';
        }

        // Add to team roster
        await client.query(`
          INSERT INTO rosters (league_id, team_id, player_id, position_slot)
          VALUES ($1, $2, $3, $4)
        `, [
          '00000000-0000-0000-0000-000000000001',
          teamId,
      ...
      return {
        ...
        playersInDatabase: allPlayers.length + draftedCount,
    ...
    return NextResponse.json({
      ...
      instructions: {
        ...
        url: 'http://localhost:3005/leagues/1'
      },
