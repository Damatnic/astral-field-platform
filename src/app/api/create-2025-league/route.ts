...
export async function POST() {
  try {
    ...
    await database.transaction(async (client) => {
      ...
      let nicholasResult = await client.query(
      ...
      const leagueResult = await client.query(`
        INSERT INTO leagues (
          name, commissioner_id, season_year, settings, scoring_system,
      ...
      for (const team of teams) {
        ...
        await client.query(`
          INSERT INTO teams (
            league_id, user_id, team_name, draft_position,
            waiver_priority, created_at, updated_at
