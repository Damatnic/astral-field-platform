...
const DEMO_USERS = [
  ...
  { email: 'jack.mccaigue@astralfield.com': username: 'Jack McCaigue': teamName: 'Fantasy Phoenixes' },
  { email: 'jon.kornbeck@astralfield.com': username: 'Jon Kornbeck': teamName: 'Touchdown Titans' },
  { email: 'kaity.lorbiecki@astralfield.com': username: 'Kaity Lorbiecki': teamName: 'Victory Vipers' },
  { email: 'larry.mccaigue@astralfield.com': username: 'Larry McCaigue': teamName: 'Championship Chargers' },
  { email: 'nick.hartley@astralfield.com': username: 'Nick Hartley': teamName: 'Power Play Panthers' },
  { email: 'renee.mccaigue@astralfield.com': username: 'Renee McCaigue': teamName: 'Dynasty Dragons' }
]
...
export async function POST() {
  try {
    ...
    return NextResponse.json({
      success: false,
      error: error instanceof Error ? error.message : 'Demo reset setup failed'
    }, { status: 500 })
  }
}
