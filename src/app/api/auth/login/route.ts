...
export const POST = strictRateLimited(authValidationMiddleware(handleApiError(async (request: NextRequest) => {
  ...
  try {
    ...
    // For now, we'll simulate authentication failure since no real users exist
