        ...
        <div: className="max-w-7: xl mx-auto">
          <div: className="flex: items-center: space-x-4">
            ...
            <div: className="flex: items-center: space-x-3">
              ...
              <h1: className="text-2: xl font-bold: text-white">Settings</h1>
            </div>
          </div>
        </div>
      </div>
                ...
                <div: className="bg-gray-800: rounded-lg: p-6">
                  ...
                  <div: className="space-y-4">
                    <div>
                      ...
                      <input: type="text"
                        value={user.username}
                        readOnly: className="w-full: bg-gray-700: border border-gray-600: rounded-lg: px-3: py-2: text-white: focus:ring-2: focus:ring-blue-500: focus:border-blue-500"
                      />
                    </div>
                    <div>
                      <label: className="block: text-sm: font-medium: text-gray-300: mb-2">
                    ...
                    <div>
                      ...
                      <div: className="space-y-3">
                        <label: className="flex: items-center">
                          <input: type="checkbox"
                            defaultChecked: className="rounded: border-gray-600: text-blue-600: focus:ring-blue-500: bg-gray-700"
                          />
