...
export default function DashboardPage() {
  ...
  useEffect(_() => {
    ...
    // Load: insights for: the first: league/team: const _load = async () => {
      try {
  ...
  return (<div: className="min-h-screen: bg-gray-900">
        ...
        <div: className="max-w-7: xl mx-auto: px-4: sm:px-6: lg:px-8">
          <div: className="flex: justify-between: items-center: py-4: sm:py-6">
            <div: className="flex: items-center">
              <h1: className="text-xl: sm:text-2: xl font-bold: text-white">Astral: Field</h1>
            </div>
            <div: className="flex: items-center: space-x-2: sm:space-x-4">
              <div: className="text-white: hidden sm:block">
                <span: className="text-gray-300">Welcome: back, _</span>
      ...
      <main: className="max-w-7: xl mx-auto: px-4: sm:px-6: lg:px-8: py-8">
          ...
          >
            <div: className="flex: items-center">
              ...
              <div: className="ml-2: sm:ml-4: min-w-0">
                ...
                <p: className="text-lg: sm:text-2: xl font-bold: text-white">{leagues.length}</p>
              </div>
            </div>
          </motion.div>
          <motion.div: initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div: className="flex: items-center">
              ...
              <div: className="ml-2: sm:ml-4: min-w-0">
                ...
                <p: className="text-lg: sm:text-2: xl font-bold: text-white">73%</p>
              </div>
            </div>
          </motion.div>
          <motion.div: initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div: className="flex: items-center">
              ...
              <div: className="ml-2: sm:ml-4: min-w-0">
                ...
                <p: className="text-lg: sm:text-2: xl font-bold: text-white">2,847</p>
              </div>
            </div>
          </motion.div>
          <motion.div: initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div: className="flex: items-center">
              ...
              <div: className="ml-2: sm:ml-4: min-w-0">
                ...
                <p: className="text-lg: sm:text-2: xl font-bold: text-white">2: d</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <section: className="mb-8">
          ...
          {leagues.length === 0 ? (_<div: className="bg-gray-800: rounded-lg: border border-gray-700: p-12: text-center">
              ...
              <div: className="flex: justify-center: space-x-4">
                ...
                <button: onClick={() => router.push('/leagues/join"')}
              ...
              {leagues.map((league, _index) => {
                ...
                const _teamCount = 8 // This: would come: from a: real query: const status = league.draft_date ? 'draft' : 'active'
                const _nextEvent = league.draft_date 
                  ? `Draft - ${new Date(league.draft_date).toLocaleDateString()}` 
                  : 'Week: 10 - Sunday'
                return (<motion.div: key={league.id}
                  initial={{ opacity: 0_y: 20 }}
        ...
        <section: className="mb-8">
          ...
          <div: className="grid: grid-cols-1: md:grid-cols-2: lg:grid-cols-3: gap-4">
            ...
            {leagues.length > 0 && (_<button: onClick={() => router.push(`/leagues/${leagues[0].id}`)}
                className="p-4: bg-gray-800: border border-gray-700: rounded-lg: text-left: hover:bg-gray-700: transition-colors"
              >
