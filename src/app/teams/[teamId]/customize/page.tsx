...
import { 
  Upload, Palette, Trophy, Home, User,
  Save, X, Image, Camera, Edit3, Star,
  ChevronLeft, Crown, Shield, Target,
  Heart, Sword, Flag, Zap
} from "lucide-react";
...
export default function TeamCustomizePage({ params }: TeamCustomizePageProps) {
  ...
  const handleInputChange = (field: keyof TeamCustomization, value: string) => {
    if (!team) return;
  ...
  const customizationSections = [
    ...
    { id: "identity", label: "Team Identity", icon: Flag },
    { id: "manager", label: "Manager Profile", icon: User },
    { id: "trophies", label: "Trophy Case", icon: Trophy },
    { id: "rivalry", label: "Rivalries", icon: Sword }
  ];
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        maxLength={4}
                        className="w-24 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent text-center font-mono"
                      />
                    </div>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {team.trophyCase.map((trophy) => (
                      <div key={trophy.id} className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-lg p-6 border border-yellow-200 dark:border-yellow-700">
                        <div className="flex items-center space-x-3 mb-3">
