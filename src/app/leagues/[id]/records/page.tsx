...
import { 
  Trophy, Crown, Target, Award, Star,
  TrendingUp, Calendar, Users, BarChart3,
  Filter, Search, Medal, Flame, Shield,
...
export default function LeagueRecordsPage({ params }: LeagueRecordsPageProps) {
  ...
  const recordCategories = [
    { id: "scoring", label: "Scoring Records", icon: Target },
    { id: "margins", label: "Victory Margins", icon: BarChart3 },
    { id: "streaks", label: "Win/Loss Streaks", icon: TrendingUp },
    { id: "individual", label: "Player Records", icon: Star },
    { id: "team", label: "Team Records", icon: Users },
    { id: "championships", label: "Championships", icon: Trophy },
    { id: "playoffs", label: "Playoff Records", icon: Award },
    { id: "draft", label: "Draft Records", icon: Crown }
  ];
  ...
  const getRecordIcon = (category: string) => {
    switch (category) {
      ...
      case 'streaks': return <TrendingUp className="w-4 h-4" />;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
            </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow mb-8">
                ...
                <div className="divide-y dark:divide-gray-700">
                  {filteredRecords.length > 0 ? filteredRecords.map((record) => (
                    <div key={record.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
