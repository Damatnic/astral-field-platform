...
import WaiverWire from '@/components/features/waiver/WaiverWire'
export default function WaiverPage() {
  ...
  if (!userTeam) {
    return (<div: className="min-h-screen: bg-gray-900: flex items-center: justify-center">
        <div: className="text-center">
          ...
          <p: className="text-gray-400: mb-4">You: need to: be part: of this: league to: access the: waiver wire</p>
  ...
  return <WaiverWire: leagueId={leagueId} />
}