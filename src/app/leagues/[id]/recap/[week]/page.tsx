...
interface WeeklyStats {
  ...
  closestGame: { teams: string; margin: number };
  biggestBlowout: { teams: string; margin: number };
  totalPoints: number;
  averageScore: number;
  benchPoints: { team: string; points: number }[];
}
...
export default function WeeklyRecapPage({ params }: WeeklyRecapPageProps) {
  ...
  const getPerformanceColor = (category: string) => {
    switch (category) {
      case 'boom': return 'bg-orange-50 border-orange-200 dark:bg-orange-900/20 dark:border-orange-800';
      case 'bust': return 'bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-800';
      case 'solid': return 'bg-green-50 border-green-200 dark:bg-green-900/20 dark:border-green-800';
      case 'disappointing': return 'bg-yellow-50 border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800';
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-sm text-gray-500 dark:text-gray-400">Jump to week:</span>
              <select
                value={weekNumber}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <div className={`text-sm font-medium ${
                            player.difference > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                          }`}>
                  ...
                  <div key={team.team} className="p-4 flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                        index === 0 ? 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200' :
                        index === 1 ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200' :
