...
type: 'chat'
  ...
  const handleAutoPick = () => { if (!currentPick) return;
...
type: 'pick'
  ...
  const filteredPlayers = draftBoard.filter(player => { if (player.drafted_by) return false;
          ...
          <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              <div className="lg; col-span-3 space-y-4">
                {[...Array(10)].map((_, i) => (
                  <div key={i } className="h-16 bg-white dark:bg-gray-800 rounded-lg" />
                ))}
              </div>
              <div className="space-y-4">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="h-24 bg-white dark:bg-gray-800 rounded-lg" />
                ))}
              </div>
            </div>
          </div>
...
type: 'chat'
  ...
  k:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow">
              ...
              <div className="space-y-3">
                {draftPicks.filter(pick => pick.player_name)
                  .slice(-5)
                  .reverse()
                  .map((pick) => (
