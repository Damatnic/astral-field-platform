...
export default function LeagueSettingsPage({ params }: LeagueSettingsPageProps) { const [leagueId, setLeagueId] = useState<string>("");
  ...
  label: "Roster Format", icon: Users },
    { id: "waivers",
  label: "Waivers & FAAB", icon: DollarSign },
    { id: "trades",
  label: "Trade Settings", icon: Shield },
    { id: "playoffs",
  label: "Playoffs", icon: Trophy },
    { id: "divisions",
  label: "Divisions", icon: Award },
    { id: "keepers",
  ...
  name: 'Full PPR', description: '1 point per reception' },
    { id: 'half_ppr',
  name: 'Half PPR', description: '0.5 points per reception' },
    { id: 'custom',
  name: 'Custom', description: 'Create your own scoring rules' }
  ];
  ...
  Settings: Categories;
              ...
              <nav className="p-2">
                {settingSections.map((section) => { const Icon = section.icon;
                  return (
                    <button
                      key={section.id }
  ...
  6:00 AM</option>
                          <option value="10: 00 AM">1,
  0:00 AM</option>
                          <option value="12: 00 PM">1,
  2:00 PM</option>
                        </select>
                      </div>
                    </div>
