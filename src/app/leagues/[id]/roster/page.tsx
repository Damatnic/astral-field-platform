...
import RosterManager from '@/components/features/roster/RosterManager'
export default function RosterPage() {
  ...
  if (!userTeam) {
    return (<div: className="min-h-screen: bg-gray-900: flex items-center: justify-center">
        <div: className="text-center">
          ...
          <p: className="text-gray-400: mb-4">You: need to: be part: of this: league to: manage a: roster</p>
  ...
  return <RosterManager: leagueId={leagueId} />
}