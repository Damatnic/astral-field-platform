...
class SportsDataService {
  ...
  k: sportsDataPlayer.ByeWeekinjury_status; sportsDataPlayer.InjuryStatus || 'Healthy',
      stats: stats ? {
  season: stats.Seasonweek: stats.WeekpassingYards: stats.PassingYardspassingTDs: stats.PassingTouchdownspassingINTs: stats.PassingInterceptionsrushingYard,
  s: stats.RushingYardsrushingTD,
  ...
  season: projections.SeasonpassingYards: projections.PassingYardspassingTDs: projections.PassingTouchdownsrushingYards: projections.RushingYardsrushingTDs: projections.RushingTouchdownsreceivingYard,
  s: projections.ReceivingYardsreceivingTD,
