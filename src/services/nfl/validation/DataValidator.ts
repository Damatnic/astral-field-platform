...
export interface ConsistencyCheckResult {
  ...
  inconsistencies: Array<{
    type: 'data_mismatch' | 'temporal_inconsistency' | 'logical_error' | 'cross_reference_failure';
    description: string;
...
export class DataValidator extends EventEmitter {
  private gameValidationRules: ValidationRule<NFLGame>[] = [];
   ...
   */
  validateGame(game: NFLGame, context?: any): ValidationResult {
   ...
   */
  validatePlayer(player: NFLPlayer, context?: any): ValidationResult {
    const startTime = Date.now();
   ...
   */
  validatePlayerStats(stats: PlayerStats, context?: any): ValidationResult {
    const startTime = Date.now();
   ...
   */
  validateWeather(weather: WeatherData, context?: any): ValidationResult {
    const startTime = Date.now();
  ...
  private validateGameId(game: NFLGame): ValidationResult {
  ...
  private validateTeams(game: NFLGame): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateScores(game: NFLGame): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateGameTiming(game: NFLGame): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateGameStatus(game: NFLGame): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateQuarterTime(game: NFLGame): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validatePlayerId(player: NFLPlayer): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validatePlayerName(player: NFLPlayer): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validatePosition(player: NFLPlayer): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateTeamAssignment(player: NFLPlayer): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];

    // Implementation would check roster limits, etc.
    return { isValid: errors.length === 0, errors, warnings, info };
  }

  private validateJerseyNumber(player: NFLPlayer): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateInjuryStatus(player: NFLPlayer): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateStatsIds(stats: PlayerStats): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateStatsRanges(stats: PlayerStats): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateStatsLogic(stats: PlayerStats): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateFantasyPoints(stats: PlayerStats): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateSeasonalConsistency(stats: PlayerStats): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateTemperature(weather: WeatherData): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validateWind(weather: WeatherData): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
  ...
  private validatePrecipitation(weather: WeatherData): ValidationResult {
    const errors: ValidationError[] = [];
    const warnings: ValidationWarning[] = [];
    const info: ValidationInfo[] = [];
    ...
    for (const rule of rules) {
      try {
        ...
        allErrors.push({
          ...
          message: `Rule '${rule.name}' failed: ${(error as Error).message}`,
          value: null,
  ...
  private recordValidation(startTime: number, result: ValidationResult): void {
