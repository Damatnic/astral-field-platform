...
describe('FantasyScoringEngine', () => {
  ...
  describe('getScoringRules', () => {
    ...
    it('should fetch scoring rules from database and cache them', async () => {
      mockDatabase.query.mockResolvedValueOnce({
        rows: [{ scoring_settings: mockScoringSettings }]
      } as any);
  ...
  describe('calculateFantasyPoints', () => {
    ...
    it('should calculate quarterback points correctly', () => {
    ...
    it('should calculate running back points correctly', () => {
    ...
    it('should calculate wide receiver points correctly', () => {
    ...
    it('should calculate kicker points correctly', () => {
    ...
    it('should calculate defense points correctly', () => {
    ...
    it('should handle bonus thresholds correctly', () => {
  ...
  describe('processLiveScoring', () => {
    ...
    it('should process all active leagues', async () => {
      const spy = jest.spyOn(fantasyScoringEngine as any, 'processLeagueScoring');
  ...
  describe('updatePlayerScore', () => {
    it('should update player score in database', async () => {
      const updatePlayerScore = (fantasyScoringEngine as any).updatePlayerScore;
    ...
    it('should handle database errors in score update', async () => {
      const updatePlayerScore = (fantasyScoringEngine as any).updatePlayerScore;
  ...
  describe('triggerPlayerScoreUpdate', () => {
    it('should manually update specific player score', async () => {
      const mockRules: ScoringRules = (fantasyScoringEngine as any).getDefaultScoringRules();
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle missing scoring rule properties', () => {
  ...
  describe('Performance and Caching', () => {
    it('should cache scoring rules efficiently', async () => {
      const leagueId = 'performance-test';
      mockDatabase.query.mockResolvedValue({
        rows: [{ scoring_settings: {} }]
      } as any);
    ...
    it('should handle large numbers of concurrent score calculations', async () => {
      const defaultRules = (fantasyScoringEngine as any).getDefaultScoringRules();
      ...
      const promises = Array.from({ length: 1000 }, (_, i) => {
        const stats = { ...baseStats, playerId: `player-${i}` };
