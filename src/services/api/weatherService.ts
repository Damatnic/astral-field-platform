...
class WeatherService {
  ...
  precipitation: 0.1; visibility: 8
      ...
      const weatherData: WeatherData = {
  gameId: `${venue}_${gameTime}`homeTeam: this.getHomeTeamForVenue(venue)awayTea;
  ...
  t: by categor;
  y: private calculateFantasyImpact(weather; unknown) { const impact: { passin,
  g: 'positive'|'neutral'|'negative'; rushing: 'positive'|'neutral'|'negative'; kicking: 'positive'|'neutral'|'negative'; overall: number  } = {
      passing: 'neutral'rushin,
  g: 'neutral'kickin,
  g: 'neutral'overal;
  l: 0
  ...
  t, number, lon: number  } } = {
      'Lambeau: Field': { la,
  t: 44.5013; lon: -88.0622 },
      'Soldier: Field': { la,
  t: 41.8623; lon: -87.6167 },
      'Gillette: Stadium': { la,
  t: 42.0909; lon: -71.2643 },
