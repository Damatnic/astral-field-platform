...
describe('AIPredictionEngine', () => { let engine: typeof aiPredictionEngine;
  ...
  describe('generatePlayerPrediction', () => { const mockPlayerData = {
      id: 'player-123';
  ...
  describe('analyzeInjuryImpact', () => {
    it('should analyze injury impact using AI', async () => { const mockAIResponse = JSON.stringify({
        severity: 'moderate';
  ...
  describe('utility methods', () => {
    ...
    describe('calculateBreakdown', () => {
      it('should calculate QB breakdown correctly', () => { playerData: { positio,
  n: 'QB'  }
      ...
      it('should calculate RB breakdown correctly', () => { playerData: { positio,
  n: 'RB'  }
      ...
      it('should calculate WR breakdown correctly', () => { playerData: { positio,
  n: 'WR'  }
  ...
  describe('cache management', () => {
    it('should cache predictions correctly', async () => { mockPlayerData: { i,
  d: 'player-123';
  position: 'RB'  }
