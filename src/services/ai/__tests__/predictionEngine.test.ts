...
describe('AIPredictionEngine', () => {
  ...
  describe('generatePlayerPrediction', () => {
    ...
    it('should generate a comprehensive player prediction', async () => {
  ...
  describe('analyzeInjuryImpact', () => {
    it('should analyze injury impact using AI', async () => {
  ...
  describe('ensemble prediction logic', () => {
    it('should combine multiple AI predictions with weighted averaging', () => {
      const predictions = [
        {
    ...
    it('should handle empty predictions array', () => {
      ...
      const playerData = { id: 'player-123', position: 'RB', week: 8 };
  ...
  describe('utility methods', () => {
    describe('calculateTrend', () => {
      it('should identify upward trend', () => {
        const scores = [25, 22, 18, 15]; // Recent scores higher
        const trend = engine['calculateTrend'](scores);
        expect(trend).toBe('up');
      });

      it('should identify downward trend', () => {
        const scores = [15, 18, 22, 25]; // Recent scores lower
        const trend = engine['calculateTrend'](scores);
        expect(trend).toBe('down');
      });

      it('should identify stable trend', () => {
        const scores = [20, 19, 20, 21]; // Similar scores
        const trend = engine['calculateTrend'](scores);
        expect(trend).toBe('stable');
      });

      it('should handle insufficient data', () => {
        const scores = [20]; // Only one score
        const trend = engine['calculateTrend'](scores);
        expect(trend).toBe('stable');
      });
    });
    ...
    describe('calculateConsistency', () => {
      it('should calculate high consistency for similar scores', () => {
        const scores = [20, 19, 21, 20, 19]; // Low variance
        const consistency = engine['calculateConsistency'](scores);
        expect(consistency).toBeGreaterThan(0.9);
      });

      it('should calculate low consistency for variable scores', () => {
        const scores = [5, 25, 10, 30, 15]; // High variance
        const consistency = engine['calculateConsistency'](scores);
    ...
    describe('calculateBreakdown', () => {
      it('should calculate QB breakdown correctly', () => {
        const playerData = { position: 'QB' };
      ...
      it('should calculate RB breakdown correctly', () => {
        const playerData = { position: 'RB' };
      ...
      it('should calculate WR breakdown correctly', () => {
        const playerData = { position: 'WR' };
  ...
  describe('cache management', () => {
    it('should cache predictions correctly', async () => {
      const mockPlayerData = { id: 'player-123', position: 'RB' };
    ...
    it('should invalidate expired cache entries', async () => {
      ...
      const expiredPrediction: PlayerPrediction = {
        playerId: 'player-123',
        week: 8,
        season: 2025,
        projectedPoints: 20,
        ...
        ceiling: 25,
        floor: 15,
        breakdown: { rushing: 14, receiving: 6 },
        factors: { matchup: 0.8, weather: 0.2, injury: 0.1, form: 0.9, gameScript: 0.7 },
