...
export default function LeagueNavigation({ leagueId }:LeagueNavigationProps) { 
  ...
  const primaryNavItems = [
    { href: `/leagues/${leagueId }`, label: "Home",
  icon:Home },
    { href: `/leagues/${leagueId}/roster`, label: "My Team",
  icon:Users },
  ...
  icon:Shuffle },
    { href: `/leagues/${leagueId}/waiver`, label: "Waiver",
  icon:DollarSign },
  ...
  icon:Target
    ...
    { href: `/leagues/${leagueId}/records`, label: "Records",
  icon:Medal },
    {
  ...
  icon:MessageSquare
    ...
    { href: `/leagues/${leagueId}/polls`, label: "Polls",
  icon:Vote },
    {
  ...
  icon:Activity
    ...
    { href: `/leagues/${leagueId}/tools`, label: "Tools",
  icon:Settings },
    ...(isCommissioner
      ? [
          {
