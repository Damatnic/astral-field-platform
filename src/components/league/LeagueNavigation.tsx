...
import { 
  ...
  BarChart3, MessageCircle, Crown, Vote,
  MessageSquare, Award, BookOpen, LineChart,
  Activity, ChevronDown, MoreHorizontal, Target,
  Clock, Medal
} from 'lucide-react';
...
export default function LeagueNavigation({ leagueId }: LeagueNavigationProps) {
  ...
  const moreNavItems = [
    { href: `/leagues/${leagueId}/research`, label: 'Research Hub', icon: Target },
    { href: `/leagues/${leagueId}/records`, label: 'Records', icon: Medal },
    { href: `/leagues/${leagueId}/recap/8`, label: 'Weekly Recap', icon: Clock },
    { href: `/leagues/${leagueId}/board`, label: 'Message Board', icon: MessageSquare },
    { href: `/leagues/${leagueId}/polls`, label: 'Polls', icon: Vote },
    { href: `/leagues/${leagueId}/power-rankings`, label: 'Power Rankings', icon: LineChart },
    { href: `/leagues/${leagueId}/transactions`, label: 'Transactions', icon: BarChart3 },
    { href: `/leagues/${leagueId}/analytics`, label: 'Analytics', icon: Activity },
    { href: `/leagues/${leagueId}/tools`, label: 'Tools', icon: Settings },
    ...(isCommissioner ? [
      { href: `/leagues/${leagueId}/settings`, label: 'League Settings', icon: Settings },
      { href: `/leagues/${leagueId}/commissioner`, label: 'Commissioner', icon: Crown }
    ] : []),
  ];
