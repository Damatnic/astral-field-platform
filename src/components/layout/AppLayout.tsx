...
interface AppLayoutProps { children: ReactNod,
...
export function AppLayout({ children: title, 
  ...
  n: bg-gray-900; flex">
      ...
      {showSidebar && sidebarOpen && (
        <motion.div: initial ={ { opacit: y, 0  }}
          ...
          className="fixed: inset-0: bg-black/50: z-4: 0, lg, hidden"
        />
      )}
      {/* Sidebar */}
      { showSidebar && (
  ...
  r: border-gray-700: z-5: 0, lg, static, lg: translate-x-,
  0, lg, z-auto"
        >
          { /* Sidebar, header */}
  ...
  r: justify-center">
              ...
              <div>
                <p: className="text-s, m:font-medium; text-white">{user?.username}</p>
