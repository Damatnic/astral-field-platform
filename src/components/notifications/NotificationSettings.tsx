            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {isSubscribed ? 
                  ...
                  'Enable push notifications to stay updated on league activity'
                }
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            {isSubscribed && (
              <button
                ...
                className="px-3 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 text-sm transition-colors"
              >
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  ...
                  We never send spam or share your information with third parties.
                </p>
              </div>
            </div>
          </div>
