...
const SettingToggle: React.FC<{
  ...
  disabled?: boolean;
}> = ({ id, label, description, checked, onChange, icon, disabled = false }) => {
  return (
    <div className={cn(
        ...
        <label htmlFor={id} className={cn("flex items-start justify-between", disabled ? "cursor-not-allowed" : "cursor-pointer")}>
          ...
          <div className="flex-shrink-0 ml-4">
            <button
              ...
              disabled={disabled}
              className={cn(
                'relative inline-flex h-6 w-11 flex-shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900',
...
const SettingSelect: React.FC<{
  ...
  icon?: React.ReactNode;
}> = ({ id, label, description, value, onChange, options, icon }) => {
  return (
...
}> = ({ title, description, icon, children, defaultExpanded = false }) => {
...
export default function EnhancedAccessibilityPanel({ className, isOpen, onClose }: EnhancedAccessibilityPanelProps) {
  ...
  return (
    ...
    >
      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-2xl bg-gray-900 shadow-xl flex flex-col">
          ...
          <div className="grid grid-cols-1 gap-3">
            {Object.entries(presets).map(([key, preset]) => (
              <button
                ...
                className={cn(
                  "text-left p-3 rounded-lg border transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500",
                  activePreset === key
          ...
          <div className="p-6 space-y-6">
            ...
            >
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('clickableAreaSize', value)}
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('stickyKeys', value)}
                icon={<Keyboard className="h-4 w-4" />}
              />
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('slowKeys', value)}
                icon={<Keyboard className="h-4 w-4" />}
              />
            </SettingSection>
            ...
            >
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('extendedTimeouts', value)}
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('confirmationDialogs', value)}
            ...
            >
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('verboseDescriptions', value)}
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('skipLinks', value)}
                icon={<Keyboard className="h-4 w-4" />}
              />
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('landmarkNavigation', value)}
                icon={<Type className="h-4 w-4" />}
              />
              ...
              <SettingToggle
                ...
                onChange={(value) => updateSetting('liveRegions', value)}
                icon={<Volume2 className="h-4 w-4" />}
              />
            </SettingSection>
          </div>
