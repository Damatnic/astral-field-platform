...
const variants = {
  ...
  secondary: {
    ...
    hover: 'hover:bg-gray-300 hover:border-gray-300',
...
export default function TouchButton({
  ...
  const handleTouchStart = useCallback(() => {
    if (loading || disabled || haptic === 'none') return;
...
export function PrimaryButton(props: Omit<TouchButtonProps, 'variant'>) {
  return <TouchButton variant="primary" {...props} />;
}

export function SecondaryButton(props: Omit<TouchButtonProps, 'variant'>) {
  return <TouchButton variant="secondary" {...props} />;
}

export function GhostButton(props: Omit<TouchButtonProps, 'variant'>) {
  return <TouchButton variant="ghost" {...props} />;
}

export function DangerButton(props: Omit<TouchButtonProps, 'variant'>) {
  return <TouchButton variant="danger" {...props} />;
}

export function SuccessButton(props: Omit<TouchButtonProps, 'variant'>) {
  return <TouchButton variant="success" {...props} />;
}

export function WarningButton(props: Omit<TouchButtonProps, 'variant'>) {
  return <TouchButton variant="warning" {...props} />;
}
...
export function FloatingActionButton({
  ...
  className?: string;
  size?: 'md' | 'lg' | 'xl';
} & Omit<TouchButtonProps, 'icon' | 'children' | 'variant' | 'fullWidth'>) {
  const sizeClasses = {
    md: 'w-14 h-14',
    lg: 'w-16 h-16', 
    xl: 'w-20 h-20'
