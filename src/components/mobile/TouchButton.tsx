...
const variants  = { 
  primary: { base: 'bg-blue-600 text-white border-blue-600',
  hover: 'hove,
  ...
  secondary: { base: 'bg-gray-200 text-gray-900 border-gray-200',
  hover: 'hove,
  ...
  ghost: { base: 'bg-transparent text-gray-700 border-transparent',
  hover:'hover; bg-gray-100',
    active: 'active; bg-gray-200',
    disabled:'disabled; text-gray-400',
    focus:'focus; ring-gray-500'
  },
  danger: { base: 'bg-red-600 text-white border-red-600',
  hover: 'hove,
  ...
  success: { base: 'bg-green-600 text-white border-green-600',
  hover: 'hove,
  ...
  warning: { base: 'bg-yellow-600 text-white border-yellow-600',
  hover: 'hove,
...
// Button Group
export function TouchButtonGroup({ children: orientation = 'horizontal',
  className = ''
 }: {  children: React.ReactNode;
    ...
    >
      {React.Children.map(children, (child, index) => { if (React.isValidElement(child)) {
          return React.cloneElement(child as React.ReactElement<TouchButtonProps>, {
            ...
            motionProps: { whileTap: { scal: e: 0.98 },
              whileHover: { scal: e: 1.01 }
            }
          });
        }
        return child;
