...
const MOCK_NEWS: NewsItem[] = [
  {
    ...
    relevantPlayers: [
      ...
      { id: 'mason', name: 'Jordan Mason', position: 'RB', team: 'SF' }
    ],
    fantasyImpact: 'critical',
    trending: true,
    isBreaking: true,
    sentiment: 'negative',
    externalUrl: 'https://espn.com/nfl/story...'
  },
  {
    id: '2',
    type: 'trade',
    ...
    relevantPlayers: [
      { id: 'jeudy', name: 'Jerry Jeudy', position: 'WR', team: 'DAL' }
    ],
    fantasyImpact: 'medium',
    trending: false,
    isBreaking: false,
    sentiment: 'positive',
    externalUrl: 'https://nfl.com/news/story...'
  },
  {
    id: '3',
    type: 'performance',
    ...
    relevantPlayers: [
      { id: 'lamar', name: 'Lamar Jackson', position: 'QB', team: 'BAL' }
    ],
    fantasyImpact: 'high',
    trending: true,
    isBreaking: false,
  ...
  },
  {
    ...
    relevantPlayers: [
      { id: 'doubs', name: 'Romeo Doubs', position: 'WR', team: 'GB' }
    ],
    fantasyImpact: 'low',
    trending: false,
    isBreaking: false,
...
export default function NewsFeed({ 
  ...
  const filterOptions = [
    ...
    { value: 'trade', label: 'Trades', icon: Users },
    { value: 'fantasy', label: 'Fantasy', icon: Trophy },
