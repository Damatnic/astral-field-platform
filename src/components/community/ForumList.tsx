          ...
          <div className="flex-shrink-0 text-right min-w-0 w-48">
            {category.lastActivity ? (
              <div className="text-sm">
                <Link 
                  href={`/community/thread/${category.lastActivity.threadTitle.toLowerCase().replace(/\s+/g, '-')}`}
...
export const ForumList: React.FC<ForumListProps> = ({
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      {/* Empty State */}
      {showCategories && categories.length === 0 && showRecentThreads && recentThreads.length === 0 && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-400 mb-6">
              Start discussions, share strategies, and connect with fellow fantasy football enthusiasts.
            </p>
            <Button 
              onClick={() => router.push('/community/thread/new')}
              variant="primary"
