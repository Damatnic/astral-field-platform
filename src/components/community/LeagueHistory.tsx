...
import {
  Trophy, Crown, Medal, Star, Calendar, TrendingUp,
  Users, Target, Award, History, ChevronRight,
  BarChart3, Zap, Shield, Flame, Clock,
...
export default function LeagueHistory({ leagueId, className }: LeagueHistoryProps) {
  const [activeTab, setActiveTab] = useState<'championships' | 'hall_of_fame' | 'records' | 'timeline'>('championships');
      ...
      <div className="space-y-4">
        {championships.map((championship, index) => (
          <div key={championship.season}>
            ...
            >
              <div className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-6 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-center justify-between">
...
function HallOfFameTab({ hallOfFame }: { hallOfFame: HallOfFamePlayer[] }) {
  return (
    <div className="space-y-6">
      {/* Hall of Fame Stats */}
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-lg">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Honoring the greatest fantasy managers in league history. Inducted based on championships, 
          consistency, and significant contributions to the league.
        </p>
      </div>
...
function RecordsTab({ records }: { records: SeasonRecord[] }) {
  ...
  const filteredRecords = selectedCategory === 'all' 
    ? records 
    : records.filter(record => record.category.includes(selectedCategory));
...
function TimelineTab({ championships }: { championships: ChampionshipHistory[] }) {
  return (
      ...
      <div className="relative">
        ...
        {championships.map((championship, index) => (
          <div key={championship.season} className="relative flex items-start space-x-6 pb-8">
            ...
            {/* Content */}
            <div className="flex-1 bg-white dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">
        ...
        <div className="relative flex items-start space-x-6">
          ...
          <div className="flex-1 bg-green-50 dark:bg-green-900/20 rounded-lg p-6 border border-green-200 dark:border-green-700">
