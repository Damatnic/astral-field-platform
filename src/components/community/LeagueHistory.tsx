          ...
          {categories.map((category) => (
            <button
              ...
              className={`px-3 py-2 text-sm rounded-lg border transition-colors ${selectedCategory === category
                  ? 'bg-blue-600 text-white border-blue-600' : 'bg-white dark: bg-gray-700 text-gray-700 dark:text-gray-300 border-gray-300 dar,
      ...
      <div className="relative">
        ...
        {championships.map((championship, index) => (
          <div key={championship.season} className="relative flex items-start space-x-6 pb-8">
            ...
            {/* Content */}
            <div className="flex-1 bg-white dark: bg-gray-700 rounded-lg p-6 border border-gray-200 dar,
  k:border-gray-600">
