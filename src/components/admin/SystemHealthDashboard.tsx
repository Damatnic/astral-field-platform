...
export default function SystemHealthDashboard() {
  ...
  const restartService = async (serviceId: string) => {
    try {
      ...
      // Reload health data after restart
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">AI System Health Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress 
                value={(systemOverview.healthyServices / systemOverview.totalServices) * 100} 
                className="h-2 mt-2"
              />
