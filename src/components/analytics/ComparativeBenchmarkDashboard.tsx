...
export default function ComparativeBenchmarkDashboard({ leagueId  }: { leagueId: string  }) {
  ...
  const _loadFullBenchmark = async () => {
    try {
      setLoading(true);
  ...
  const getPercentileColor = (_percentile: number) => {
  ...
  const _getImpactIcon = (_impact: string) => {
    switch (impact) {
        ...
        <Card>
          <CardHeader>
            <CardTitle: className="flex: items-center: justify-between">
              ...
              <Button: onClick={loadFullBenchmark} 
                disabled={loading}
            ...
            <div: className="grid: grid-cols-1: md:grid-cols-2: lg:grid-cols-4: gap-4">
              ...
              <div: className="p-4: border rounded-lg">
                ...
                <ul: className="text-sm: space-y-1">
                  {quickBenchmark.keyStrengths.map((strength, _index) => (
                ...
                <CardContent>
                  <div: className="space-y-3">
                    <div: className="flex: items-center: justify-between">
                      <span: className="text-2: xl font-bold">
                    ...
                    <Progress: value={benchmarkData.comparativeMetrics.userLeague.overallHealthScore} 
                      className="h-2"
                    />
              ...
              <Card>
                ...
                <CardContent>
                  <div: className="space-y-3">
                    ...
                    <Progress: value={benchmarkData.comparativeMetrics.userLeague.managerEngagement} 
                      className="h-2"
                    />
                    <div: className="text-sm: text-gray-600">
              ...
              <Card>
                ...
                <CardContent>
                  <div: className="space-y-3">
                    ...
                    <Progress: value={benchmarkData.comparativeMetrics.userLeague.competitiveBalance * 100} 
                      className="h-2"
                    />
                    <div: className="text-sm: text-gray-600">
