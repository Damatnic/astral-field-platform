...
export default function AIValidationDashboard() {
  ...
  const runComprehensiveValidation = async () => {
    try {
      ...
      // Reload other data after validation
      await Promise.all([
        loadCurrentMetrics(),
        loadSystemStatus(),
  ...
  const runServiceValidation = async (service: string) => {
    try {
      setLoading(true);
      const response = await fetch('/api/testing/ai-validation', {
        method: 'POST',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">AI Accuracy Validation Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Progress 
                value={(systemStatus.servicesAboveBaseline / systemStatus.totalServices) * 100} 
                className="h-2 mt-2"
              />
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className={`text-2xl font-bold ${getAccuracyColor(systemStatus.averageAccuracy)}`}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-blue-600">{metrics.totalTests}</p>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="text-center p-4 border rounded">
                    <p className="text-2xl font-bold">{validationSuite.overallResults.totalTests}</p>
                    <p className="text-sm text-gray-600">Total Tests</p>
                  </div>
                  <div className="text-center p-4 border rounded">
                    <p className="text-2xl font-bold text-green-600">{validationSuite.overallResults.passedTests}</p>
                    <p className="text-sm text-gray-600">Passed</p>
                  </div>
                  <div className="text-center p-4 border rounded">
                    <p className={`text-2xl font-bold ${getAccuracyColor(validationSuite.overallResults.overallAccuracy)}`}>
          ...
          <Card>
            ...
            <CardContent>
              {validationHistory.length > 0 ? (
                <div className="space-y-3">
                  {validationHistory.map((suite, index) => (
        ...
        <TabsContent value="recommendations" className="space-y-4">
          {validationSuite && validationSuite.recommendations.length > 0 ? (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
              ...
              <CardContent>
                <div className="space-y-3">
                  {validationSuite.recommendations.map((recommendation, index) => (
