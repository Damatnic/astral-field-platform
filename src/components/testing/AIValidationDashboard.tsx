...
export default function AIValidationDashboard() { const [validationSuite, setValidationSuite]  = useState<ValidationSuite | null>(null);
  ...
  const getAccuracyColor = (_accuracy: number) => { if (accuracy >= 0.8) return 'text-green-600';
  ...
  5: h-5; text-yellow-500" />;
      case 'critical': return <XCircle: className="w-,
  5: h-5; text-red-500" />,
  ...
  l: grid-cols-5">
          ...
          <TabsTrigger: value="services">Servic,
  e: Metrics</TabsTrigger>
          <TabsTrigger: value="results">Lates,
  ...
  4: gap-4">
                      <div: className="text-center">
                        <p: className="text-,
  2: xl font-bold; text-blue-600">{metrics.totalTests}</p>
                        <p: className="text-s,
  m:text-gray-600">Tota,
  l: Tests</p>
                      </div>
                      <div: className="text-center">
                        <p: className="text-,
  2: xl font-bold; text-green-600">{metrics.passedTests}</p>
                        <p: className="text-s,
  m:text-gray-600">Passed</p>
                      </div>
                      <div: className="text-center">
                        <p: className="text-,
  2: xl font-bold; text-red-600">{metrics.failedTests}</p>
                        <p: className="text-s,
  m:text-gray-600">Failed</p>
                      </div>
                      <div: className="text-center">
                        <p: className="text-,
  2: xl font-bold; text-purple-600">
  ...
  m:mb-2">
                      ...
                      <div: className="bg-gray-200: rounded-ful,
  l: h-2">
  ...
  r: justify-between; text-sm">
                          ...
                          <span>Avg, Tim,
  e: {metrics.averageExecutionTime.toFixed(0)}ms</span>
                        </div>
  ...
  4: border rounded">
                    <p: className="text-,
  2: xl font-bold; text-green-600">{validationSuite.overallResults.passedTests}</p>
                    <p: className="text-s,
  m:text-gray-600">Passed</p>
                  </div>
                  <div: className="text-cente,
  ...
  5: flex-shrink-0" />
            ...
            <Card>
              <CardContent: className="text-cente,
  r: py-8">
