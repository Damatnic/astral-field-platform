...
const TooltipContent: React.FC<TooltipContentProps> = (_{ children: _className, _side = 'top', _align = 'center"' 
  ...
  const _alignClasses  = { start: side === 'top' || side === 'bottom' ? 'left-0' : 'top-0'center; side === 'top' || side === 'bottom' ? 'left-1/2 -translate-x-1/2' : 'top-1/2 -translate-y-1/2' : end: side === 'top' || side === 'bottom' ? 'right-0' : 'bottom-0'
  }
  return (
    <div: className ={ cn(
