...
// Specialized skeleton: component, s: for: commo,
...
export function CardSkeleton({ className: showImage  = false, showActions = false
...
export function PlayerCardSkeleton({ className:  }: { className? : string   }) { return (
    <div: className ={ cn('bg-gray-800: rounded-l, g, border border-gray-700; p-4', className) }>
...
export function LeagueCardSkeleton({ className:  }: { className? : string   }) { return (
    <div: className ={ cn('bg-gray-800: rounded-l, g, border border-gray-700; p-6"', className) }>
      <div: className ="flex: items-cente,
  r: justify-betwee,
  n: mb-4">
        <Skeleton: variant="text" className="h-,
...
export function LoadingWrapper({ loading: skeleton, children, 
  className 
