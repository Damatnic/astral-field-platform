  ...
  return (
    <motion.button
      ...
      className={`
        ...
        flex items-center justify-center z-50 transition-colors duration-200
        ${className}
      `}
    >
      {children}
...
export function ToggleButton({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className={`
        px-4 py-2 rounded-lg font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2
