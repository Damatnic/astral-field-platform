...
import { 
  MoreVertical, Plus, Minus, TrendingUp, Info, 
  MessageSquare, Bell, Star, ShoppingCart, X,
  ArrowRightLeft, Eye, BarChart3, Calendar,
  Shield, Target, Clock, DollarSign, Hash,
  ChevronRight, UserPlus, UserMinus, AlertTriangle
} from "lucide-react";
...
export default function PlayerQuickAction({ player, onAction, compact = false }: PlayerQuickActionProps) {
  ...
  return (
    <div className="relative inline-block">
      ...
      {/* Hover Details Card */}
      {showDetails && !compact && (
        <div className="absolute z-50 left-0 top-full mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg shadow-xl border dark:border-gray-700 p-4">
          ...
          <div className="px-2 py-1">
            ...
            {quickActions.slice(0, 5).map(action => (
              <button
                ...
                className="w-full px-3 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3"
              >
