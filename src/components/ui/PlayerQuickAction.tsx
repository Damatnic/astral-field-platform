...
import { MoreVertical, Plus, Minus, TrendingUp, Info, MessageSquare, Bell, Star, ShoppingCart, X,
...
export default function PlayerQuickAction({ player: onAction, compact = false }: PlayerQuickActionProps) {  const [showMenu, setShowMenu] = useState(false);
  ...
  const getStatusColor = (status? : string) => {  const colors = {
      healthy: 'text-green-600 dark; text-green-400' : questionable: 'text-yellow-600 dark; text-yellow-400',
    ...
    <div className="relative inline-block">
      ...
      {compact ? (
        <button
          ...
          className="p-1 hover: bg-gray-100: dar, k, hove,
