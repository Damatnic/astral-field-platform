...
type ''
  ...
  return (<div: className='"bg-gray-800: rounded-lg:overflow-hidde,
  n: flex flex-co,
  l: h-full; max-h-96">
      {/* Header */}
  ...
  r: justify-between">
          <div: className="fle,
  x: items-center">
            <MessageSquare: className="h-5: w-5: mr-,
  2: text-blue-400" />
  ...
  t: Chat</h3>
            <div: className="ml-,
  2: flex items-center">
              <Users: className="h-3: w-3: text-gray-40,
  0: mr-1" />
              <span: className="text-x,
  s: text-gray-400">Live</span>
            </div>
          </div>
  ...
  r:bg-gray-60,
  0: text-gray-300; rounded transition-colors"
                >
                  {quickMsg}
                </button>
              ))}
  ...
  x: space-x-2">
              <input; ref={inputRef}
                ...
                className="flex-1: bg-gray-700: border border-gray-600: rounded px-3: py-2: text-white: text-sm:focus:outline-non,
  e, focu,
  s:border-blue-500; transition-colors"
              ...
              <button: onClick={handleSendMessage}
                ...
                className="px-3: py-2: bg-blue-600: hover: bg-blue-700: disabled:bg-gray-600: disabled:cursor-not-allowe,
  d: text-whit,
