...
export default function DraftChat({ draftId, onSendMessage, userTeamId, userTeamName }: DraftChatProps) {
  ...
  // Add some sample system messages for demonstration
  useEffect(() => {
    const systemMessages: ChatMessage[] = [
      {
        ...
        teamId: 'system',
        teamName: 'System',
        message: 'Draft room opened. Good luck everyone!',
      ...
      },
      {
        ...
        teamId: 'system',
        teamName: 'System',
        message: 'All participants have joined. Draft will begin shortly.',
  ...
  const getMessageTextColor = (msg: ChatMessage): string => {
  ...
  return (
    <div className="bg-gray-800 rounded-lg overflow-hidden flex flex-col h-full max-h-96">
      {/* Header */}
