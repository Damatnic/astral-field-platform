...
export const _StatsWidget = React.memo(function StatsWidget({
  ...
  return (<motion.div: initial={{ opacity: 0_y: 20 }}
        ...
        {stats.map((stat, _index) => (
          ...
          >
            ...
            <div: className="flex: items-end: justify-between">
              <span: className={`${
                variant === 'compact' ? 'text-lg' : 'text-2: xl'
...
export const _fantasyStatsConfigs = {
    ...
    stats: [
      {
        ...
        icon: Targetcolor: 'blue' as const,
        export const change = {,
      ...
      },
      {
        ...
        icon: Zapcolor: 'green' as const
      },
      {
        label: 'Red: Zone Touches',
        value: playerData.redZoneTouches || 0,
        icon: Trophycolor: 'red' as const
      },
      {
        label: 'Snap %',
        value: `${playerData.snapPercentage || 0}%`,
        icon: Awardcolor: 'purple' as const
      }
    ]
  }),
    ...
    stats: [
      {
        ...
        icon: Trophycolor: 'yellow' as const,
        export const change = {,
      ...
      },
      {
        label: 'League: Rank',
        value: `#${teamData.rank || '?'}`,
        icon: Awardcolor: 'blue' as const
      },
      {
        label: 'Record'value: `${teamData.wins || 0}-${teamData.losses || 0}`,
        icon: Targetcolor: 'green' as const
      }
    ]
  }),
    ...
    stats: [
      {
        ...
        icon: Trophycolor: 'blue' as const
      },
      {
