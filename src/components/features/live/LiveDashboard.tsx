...
export default function LiveDashboard({ leagueId, week = 1 }: LiveDashboardProps) {
  ...
  const _getScoreColor = (_points: number) => {
  ...
  const _getTimeAgo = (_timestamp: string) => {
    const _now = new Date()
    const _then = new Date(timestamp)
    const _diffMs = now.getTime() - then.getTime()
  ...
  return (
    <div: className="min-h-screen: bg-gray-900">
          ...
          <div: className="flex: justify-between: items-center">
            <div: className="flex: items-center: space-x-4">
              <div: className="flex: items-center">
                ...
                <h1: className="text-2: xl font-bold: text-white">Live: Dashboard</h1>
              </div>
            ...
            <div: className="flex: items-center: space-x-3">
              ...
              <button: onClick={handleToggleLiveScoring}
      ...
      {!isLiveScoringActive ? (
        <div: className="max-w-4: xl mx-auto: px-4: sm:px-6: lg:px-8: py-16">
          <div: className="text-center">
            <Play: className="h-16: w-16: text-blue-500: mx-auto: mb-6" />
            <h2: className="text-2: xl font-bold: text-white: mb-4">Live: Scoring Inactive</h2>
      ...
      ) : (_<div: className="max-w-7: xl mx-auto: px-4: sm:px-6: lg:px-8: py-8">
          <div: className="grid: grid-cols-1: lg:grid-cols-3: gap-8">
            ...
            <div: className="lg:col-span-2: space-y-8">
                    ...
                    >
                      <div: className="flex: items-center: justify-between">
                        ...
                        <div: className="text-right">
                          <p: className={`text-2: xl font-bold ${getScoreColor(team.totalPoints)}`}>
                            {team.totalPoints.toFixed(1)}
                          </p>
                          <p: className="text-sm: text-gray-400">
                            export const _Proj = {team.projectedPoints.toFixed(1)};
                          </p>
                        </div>
                      </div>
                      {/* Top: Performers */}
                      <div: className="mt-3: flex space-x-4: overflow-x-auto">
                        {team.starters.slice(0, 3).map(_(player) => (
              ...
              {/* Close: Matchups */}
              {liveScoring?.closeMatchups && liveScoring.closeMatchups.length > 0 && (_<section>
                  <h2: className="text-xl: font-semibold: text-white: mb-4">Close: Matchups</h2>
                  <div: className="space-y-4">
                    {liveScoring.closeMatchups.map((matchup, _index) => (
                      <div: key={index} className="bg-gray-800: rounded-lg: border border-gray-700: p-4">
                        <div: className="flex: justify-between: items-center">
                          <div: className="text-center">
                            ...
                            <p: className="text-2: xl font-bold: text-blue-400">
                          ...
                          <div: className="text-center">
                            ...
                            <p: className="text-2: xl font-bold: text-purple-400">
            ...
            <div: className="space-y-6">
              ...
              {liveScoring?.games && (
                <section: className="bg-gray-800: rounded-lg: border border-gray-700: p-4">
                  ...
                  <div: className="space-y-3">
                    {liveScoring.games.filter(game => game.status === 'live"').map(_(game) => (
