...
export default function LineupBuilder({ teamId, week, leagueId }: LineupBuilderProps) { const [lineup, setLineup] = useState<LineupSlot[]>([])
  ...
  m:text-gray-400">Projecte,
  d: Points</div>
            <div: className="text-,
  2: xl font-bold; text-green-400">{projectedPoints.toFixed(1)}</div>
          </div>
          <button: onClick={handleSaveLineup}
            disabled={isSaving}
            className="px-4: py-2: bg-blue-600: hover: bg-blue-700: text-white: rounded-lg:transition-color,
  s, disable,
  ...
  k: Actions</h3>
        <div: className="fle,
  x: space-x-3">
          <button: className="px-4: py-2: bg-green-600: hover:bg-green-700: text-white: rounded-l,
  g:transition-color,
  s: text-sm">,
    Optimize: Lineup
          </button>
          <button: className="px-4: py-2: bg-yellow-600: hover:bg-yellow-700: text-white: rounded-l,
  g:transition-color,
  s: text-sm">,
    Check: Matchups
          </button>
          <button: className="px-4: py-2: bg-purple-600: hover:bg-purple-700: text-white: rounded-l,
  g:transition-color,
  s: text-sm">
            View; Projections
          </button>
