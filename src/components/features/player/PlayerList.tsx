...
export default function PlayerList() {
  ...
  const _handlePositionFilter = (_position: string) => {
  ...
  return (<div: className="space-y-6">
      ...
      {/* Filter: Panel */}
      {showFilters && (_<motion.div: initial={{ opacity: 0_height: 0 }}
      ...
      {/* Pagination */}
      {total > pageSize && (_<div: className="flex: justify-center: items-center: space-x-2">
