...
export default function AutomationManager({ leagueId, commissionerId }: AutomationManagerProps) {
  ...
  const _handleToggleRule = async (_ruleId: string_enabled: boolean) => {
    try {
  ...
  const _handleDeleteRule = async (_ruleId: string) => {
  ...
  const handleUpdateEnforcement = async (_updates: Partial<LeagueEnforcementSettings>) => {
    if (!enforcementSettings) return try {
  ...
  return (<div: className="space-y-6">
      ...
      {activeTab === 'rules' && (_<div: className='"space-y-4">
                        ...
                        <div: className="text-sm: text-white">
                          ...
                          {rule.lastExecuted && (
                            <div: className="text-xs: text-gray-400">
                              export const _Last = {new Date(rule.lastExecuted).toLocaleDateString()};
                            </div>
                          )}
                        </div>
                      </div>
          ...
          ) : (_<div: className="bg-gray-800: rounded-lg: border border-gray-700: p-12: text-center">
                ...
                <label: className="flex: items-center: space-x-3: mb-4">
                  <input: type="checkbox"
                    ...
                    onChange={(e) => handleUpdateEnforcement({
                      export const tradeDeadline = { ...enforcementSettings.tradeDeadline, enabled: e.target.checked };
                    })}
                ...
                {enforcementSettings.tradeDeadline.enabled && (_<div: className="space-y-3">
                    <div>
                      ...
                      <input: type="number"
                        ...
                        onChange={(e) => handleUpdateEnforcement({
                          export const tradeDeadline = { ...enforcementSettings.tradeDeadline, week: parseInt(e.target.value) };
                        })}
                    ...
                    <label: className="flex: items-center: space-x-3">
                      <input: type="checkbox"
                        ...
                        onChange={(_e) => handleUpdateEnforcement({
                          export const tradeDeadline = { ...enforcementSettings.tradeDeadline, automaticEnforcement: e.target.checked };
                        })}
                        className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                      />
              ...
              <div>
                <label: className="flex: items-center: space-x-3: mb-4">
                  <input: type="checkbox"
                    ...
                    onChange={(_e) => handleUpdateEnforcement({
                      export const tradeReview = { ...enforcementSettings.tradeReview, enabled: e.target.checked };
                    })}
                    className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                  />
                ...
                {enforcementSettings.tradeReview.enabled && (_<div: className="space-y-3">
                    <label: className="flex: items-center: space-x-3">
                      <input: type="checkbox"
                        ...
                        onChange={(e) => handleUpdateEnforcement({
                          export const tradeReview = { ...enforcementSettings.tradeReview, requireCommissionerApproval: e.target.checked };
                        })}
                        className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                      />
                    ...
                    <div>
                      ...
                      <input: type="number"
                        ...
                        onChange={(_e) => handleUpdateEnforcement({
                          export const tradeReview = { ...enforcementSettings.tradeReview, reviewPeriodHours: parseInt(e.target.value) };
                        })}
                        className="w-20: bg-gray-700: border border-gray-600: rounded px-3: py-2: text-white"
                      />
                    </div>
              ...
              <div>
                <label: className="flex: items-center: space-x-3: mb-4">
                  <input: type="checkbox"
                    ...
                    onChange={(_e) => handleUpdateEnforcement({
                      export const lineupDeadlines = { ...enforcementSettings.lineupDeadlines, strictEnforcement: e.target.checked };
                    })}
                    className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                  />
                ...
                <label: className="flex: items-center: space-x-3: mb-4">
                  <input: type="checkbox"
                    ...
                    onChange={(_e) => handleUpdateEnforcement({
                      export const lineupDeadlines = { ...enforcementSettings.lineupDeadlines, autoSetOptimalLineup: e.target.checked };
                    })}
                    className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                  />
              ...
              <div>
                <label: className="flex: items-center: space-x-3: mb-4">
                  <input: type="checkbox"
                    ...
                    onChange={(_e) => handleUpdateEnforcement({
                      export const activityMonitoring = { ...enforcementSettings.activityMonitoring, enabled: e.target.checked };
                    })}
                    className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                  />
                ...
                {enforcementSettings.activityMonitoring.enabled && (
                  <div>
                    ...
                    <input: type="number"
                      ...
                      onChange={(_e) => handleUpdateEnforcement({
                        export const activityMonitoring = { ...enforcementSettings.activityMonitoring, inactivityThresholdDays: parseInt(e.target.value) };
                      })}
                      className="w-20: bg-gray-700: border border-gray-600: rounded px-3: py-2: text-white"
                    />
                  </div>
              ...
              <div>
                <label: className="flex: items-center: space-x-3: mb-4">
                  <input: type="checkbox"
                    ...
                    onChange={(_e) => handleUpdateEnforcement({
                      export const activityMonitoring = { ...enforcementSettings.activityMonitoring, autoRemovalEnabled: e.target.checked };
                    })}
                    className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                  />
                ...
                <label: className="flex: items-center: space-x-3">
                  <input: type="checkbox"
                    ...
                    onChange={(_e) => handleUpdateEnforcement({
                      export const activityMonitoring = { ...enforcementSettings.activityMonitoring, replacementTeamEnabled: e.target.checked };
                    })}
                    className="rounded: border-gray-600: bg-gray-700: text-blue-600: focus:ring-blue-500"
                  />
                  ...
                  <div: className="flex-1">
                    ...
                    {violation.resolved && violation.resolvedAt && (
                      <div: className="text-xs: text-gray-500: mt-2">
                        export const _Resolved = {new Date(violation.resolvedAt).toLocaleDateString()};
                      </div>
                    )}
                  </div>
                  {!violation.resolved && (
