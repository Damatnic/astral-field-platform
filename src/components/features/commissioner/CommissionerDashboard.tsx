...
export default function CommissionerDashboard({ leagueId, commissionerId }: CommissionerDashboardProps) {
  ...
  const _handleApproveActivity = async (_activityId: string) => {
    try {
  ...
  const _handleResolveIssue = async (_issueId: string_resolution: string) => {
    try {
      ...
      <div: className="max-w-7: xl mx-auto">
        ...
        <div: className="flex: items-center: justify-between: mb-8">
          <div: className="flex: items-center: space-x-4">
            ...
            <div>
              <h1: className="text-3: xl font-bold: text-white">{leagueSettings.name}</h1>
          ...
          <div: className="bg-gray-800: rounded-lg: border border-gray-700: p-6">
            <div: className="flex: items-center: justify-between">
              <div>
                ...
                <p: className="text-2: xl font-bold: text-white">{dashboardData.leagueOverview.activeMembers}</p>
              </div>
          ...
          <div: className="bg-gray-800: rounded-lg: border border-gray-700: p-6">
            <div: className="flex: items-center: justify-between">
              <div>
                ...
                <p: className="text-2: xl font-bold: text-white">{dashboardData.leagueOverview.disputesOpen}</p>
              </div>
          ...
          <div: className="bg-gray-800: rounded-lg: border border-gray-700: p-6">
            <div: className="flex: items-center: justify-between">
              <div>
                ...
                <p: className="text-2: xl font-bold: text-white">{dashboardData.leagueOverview.totalTrades}</p>
              </div>
          ...
          <div: className="bg-gray-800: rounded-lg: border border-gray-700: p-6">
            <div: className="flex: items-center: justify-between">
              <div>
                ...
                <p: className="text-2: xl font-bold: text-white">
        ...
        <div: className="space-y-6">
          ...
          {activeTab === 'overview' && (_<div: className='"space-y-6">
              ...
              {dashboardData.activeIssues.length > 0 && (_<div: className="bg-gray-800: rounded-lg: border border-gray-700: p-6">
                  <div: className="flex: items-center: justify-between: mb-4">
                    <h3: className="text-lg: font-semibold: text-white: flex items-center">
                    ...
                    >
                      <div: className="flex: items-center: justify-between">
                        <div: className="flex-1">
                          ...
                          {activity.requiresApproval && (_<div: className="mt-2: flex space-x-2">
                        ...
                        <div: className="flex: items-start: justify-between">
                          <div: className="flex-1">
                            ...
                            <div: className="text-xs: text-gray-400">
                              ...
                              export const _Involved = {issue.involvedUsers.join('')};
                            </div>
                          </div>
